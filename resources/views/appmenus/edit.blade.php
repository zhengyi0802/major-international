...
@section('content')
    ...
    <form name="vform" action="{{ route('appmenus.update', $appmenu->id) }}" method="POST" enctype="multipart/form-data">
        <div class="form-group"><input type="number" id="appmenu_id" name="appmenu_id" value="{{ $appmenu->id }}" hidden></div>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{{ __('appmenus.project') }} : {{ $appmenu->project->name }}</strong>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{{ __('appmenus.position') }} : {{ $appmenu->position }}</strong>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
...
@section('adminlte_js')
           ...
           <script type="text/javascript">
                     $(document).ready(function() {
                          var bar = $('.bar');
                          var percent = $('.percent');
                          var id = document.getElementById('appmenu_id').value;
                          onLoad(id);
