...
@section('content')
    ...
    <form name="vform" action="{{ route('appmenus.store2', ['project' => $project, 'position' => $position]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12" id="div-external0" style="display:none" >
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12" id="div-external2" style="display:none" >
                <div class="form-group">
                    ...
                    <div id="div-preview">
                        <img name="preview" id="preview" width="160" height="160">
                    </div>
                </div>
                <script>
