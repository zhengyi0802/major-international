...
@section('content')
    ...
    <form action="{{ route('advertisings.store2', ['advertising' => $advertising, 'project' => $project]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>{{ __('advertisings.link_image') }} :</strong>
                    <input type="radio" name="link_image" value="1" {{ ($advertising->link_image==1) ? "checked":null }} >{{ __('tables.status_on') }}
                    <input type="radio" name="link_image" value="0" {{ ($advertising->link_image!=1) ? "checked":null }} >{{ __('tables.status_off') }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
