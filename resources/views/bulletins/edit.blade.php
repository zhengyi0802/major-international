        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="radio" name="popup" value="1" {{ ($bulletin->popup==1) ? "checked":null }} >{{ __('tables.status_on') }}
                    <input type="radio" name="popup" value="0" {{ ($bulletin->popup!=1) ? "checked":null }} >{{ __('tables.status_off') }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
